...
public class ConsultaAntigua extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ConsultaAntigua.class.getName());

    /**
     * Creates new form Consultas1
     */
    public ConsultaAntigua() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ConsultaAntigua().setVisible(true));
    }
